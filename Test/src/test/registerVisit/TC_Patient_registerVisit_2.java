...
public class TC_Patient_registerVisit_2 {
	...
	@Test
	public void TC_Patient_SearchProvider_2() throws IOException {
		...
		driver.findElement(By.xpath(".//*[@id='calendar_cal']")).sendKeys("09-20-2016");
		...
		assertEquals("enter correct dates.", error);

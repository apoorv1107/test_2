...
public class TC_Patient_registerVisit_3 {
	...
	@Test
	public void TC_Patient_SearchProvider_3() throws IOException {
		...
		driver.findElement(By.xpath(".//*[@id='calendar_cal']")).sendKeys("09-22-2016");
		...
		assertEquals("select provider.", error);

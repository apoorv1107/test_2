...
public class TC_admin_addProvider_1 {
	...
	public void TC_admin_addProvider_1() throws IOException {
		...
		driver.findElement(By.xpath("//*[@id='providerId_input']")).sendKeys("PRV150");
		driver.findElement(By.xpath("//*[@id='firstName_input']")).sendKeys("demo");
		driver.findElement(By.xpath("//*[@id='lastName_input']")).sendKeys("demo");
		driver.findElement(By.xpath("//*[@id='location_input']")).sendKeys("bangalore");
		driver.findElement(By.xpath("//*[@id='email_input']")).sendKeys("demo@demo.com");
		WebElement SelectElement = driver.findElement(By.xpath(".//*[@id='dropDownId1']"));
		Select Dropdown = new Select(SelectElement);
		Dropdown.selectByVisibleText("Hospital");
		
		driver.findElement(By.xpath("//*[@id='ssn_input']")).sendKeys("89456789");
		...
		String success = driver.findElement(By.xpath(".//*[@id='successMessage-description']/span")).getText();
		System.out.println(success);
		assertEquals("Provider addition successful", success);

...
public class TC_admin_addPatient_1 {
	...
	@Test
	public void TC_admin_addPatient_1() throws IOException {
		...
		driver.findElement(By.xpath("//*[@id='patientId_input']")).sendKeys("PAT231");
		driver.findElement(By.xpath("//*[@id='firstname_input']")).sendKeys("apoorv");
		driver.findElement(By.xpath("//*[@id='lastname_input']")).sendKeys("tiwari");
		...
		assertEquals("Patient addition successful", success);

...
public class TC_Patient_myVisits_1 {
	...
	@Test
	public void TC_Patient_myVisits_1() throws IOException {
		...
		assertEquals("Your visits are displayed below",driver.findElement(By.xpath("html/body/div/div[1]/div[3]/center")).getText());
